      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
        <div className="bg-white rounded-2xl shadow-2xl w-full max-w-lg max-h-[85vh] flex flex-col">
          ...
          <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100 flex-shrink-0">
            <h2 className="font-display text-xl font-semibold text-kb-charcoal">Exchange Policy</h2>
            <button
              onClick={onClose}
          ...
          <div className="px-6 py-4 border-t border-gray-100 flex-shrink-0">
            <a
              ...
              className="flex items-center justify-center gap-2 w-full py-2.5 rounded-xl text-white text-sm font-medium transition-opacity hover:opacity-90"
